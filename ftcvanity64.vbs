...
objShell.Run"%comspec% /k \FTCVanity\vanitygen64.exe" & " -X 14 -i " & strInput, 1, true
...
Function VanityInput( myPattern )
    ...
    Else
        ' If not, use InputBox
        VanityInput = InputBox( myPattern , "FTCVanity64"  )
	...
	Else
		...
		"  To import the generated keys into the Feathercoin client please refer to \FTCVanity\README or the Project page over @ the Feathercoin forum:  " & VBNewline & "http://forum.feathercoin.com/index.php?topic=489.0",64, "FTCVanity64")
