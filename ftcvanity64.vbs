...
Set objShell = CreateObject("Wscript.Shell")
Return = objShell.Run("%comspec% /k vanitygen64.exe" & " -X " & version & " -o tmp.txt" & " -i " & strInput  , 2 , false )
...
if isProcessRunning(strComputer,strProcess) then
	...
	MsgBox"ERROR!" & VBNewline & VBNewline & CHR (149) & "  Unable to generate valid " & name & " address from input pattern!" & VBNewline & CHR (149) & "  Pattern: " & strInput , 16 , "FTCVanity64 " & name
