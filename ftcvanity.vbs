...
if isProcessRunning(strComputer,strProcess) then
	...
	MsgBox"ERROR!" & VBNewline & VBNewline & CHR (149) & "  Unable to generate valid Feathercoin address from input pattern!" & VBNewline & CHR (149) & "  Pattern: " & strInput , 16 , "FTCVanity " & name
